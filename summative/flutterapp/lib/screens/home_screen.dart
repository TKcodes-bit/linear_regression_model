  ...
  Future<void> predict() async {
    ...
    try {
      final vehicle = Vehicle(
        ...
        engineSize: double.parse(engineSizeController.text),
        ...
        fuelCity: double.parse(fuelCityController.text),
        fuelHwy: double.parse(fuelHwyController.text),
        fuelComb: double.parse(fuelCombController.text),
        fuelMpg: double.parse(fuelMpgController.text),
      );
